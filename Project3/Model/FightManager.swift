...
private func refresh(characterArray: [Character], hpLabelArray: [UILabel], buttonCharacterArray: [UIButton]) {
    for index in 0...5 {
        hpLabelArray[index].text = String(characterArray[index].race.health)
    }
    currentAction = ""
...
private func doAction(view: UIViewController, buttonArray: [UIButton], hpLabelArray: [UILabel], currentCLabel: UILabel, currentCHeal: UILabel, currentCAttack: UILabel) {
    ...
    characterIsDead(character: currentTarget!, buttonCharacterArray: buttonArray)
    isGameOver()
...
private func randomChest(view: UIViewController) {
